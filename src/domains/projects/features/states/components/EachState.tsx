        ...
        {!isEditing ? (
          ...
          <form className="w-full" onSubmit={handleSubmit(submitHandler)}>
            <input
              autoFocus
              type="text"
              className="w-full px-1 text-neutral-900 rounded-sm outline-hidden bg-neutral-50 dark:bg-neutral-800 dark:text-neutral-100 dark:focus:ring-2 dark:focus:ring-teal-500 focus:ring-2 focus:ring-blue-500"
